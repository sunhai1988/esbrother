...
public class LpsfCompanyDaoImpl extends BaseBO implements LpsfCompanyDao {
	...
	public void deleteCompany(String[] ids) {
		if (ids.length == 1) {
			commonDAO.delete("from LpsfCompany as o where o.id = ?", ids);
		} else {
			StringBuffer hql = new StringBuffer(256);
			hql.append("from LpsfCompany as o where o.id in ");
